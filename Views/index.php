		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content" >
									...
									<nav id="service_nav" class="navbar navbar-default" role="navigation">
										<div class="container-fluid">
											<ul class="nav navbar-nav">
												<li class="text-center"><a href="#"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;Chi tiết&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></li>
												<li class="text-center"><a href="#"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Đánh giá&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></li>
												<li class="text-center"><a href="#"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Về địa điểm này&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></li>
											</ul>
										</div>
									</nav>
								</div>
				...
				<div class="modal-footer" id="footer_login">
					...
					<button type="button" id="check_login_btn" onclick="login()" class="btn btn-default">
						Đăng Nhập
					</button>
				</div>
			</div>
